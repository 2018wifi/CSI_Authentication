...
for t in range(1, 9):
    for i in range(201, 251):
        ...
        point, probs, time_cost = detect(matrix)
        print("T{0}_{1}检测结果: 最大可能地点: {2}\t概率: {3}\t花费时间: {4} us".format(t, i, point, probs, time_cost))
...
#     print("检测结果{0}: 最大可能地点: {1}\t方差: {2}\t花费时间: {3} us".format(i, point, round(variance, 3), time_cost))
#     test_time.append(time_cost)
